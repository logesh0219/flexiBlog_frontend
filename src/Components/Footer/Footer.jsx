    ...
    <footer>
      <div className="container">
        <div className="footer-blk">
          <div className="company-copyrights">
            <div className="footer-logo">
              {
                toggle
                  ?

                  <img style={{ filter: "grayscale(1)", opacity: 1, verticalAlign: "middle" }}
                    src='https://flexiblog-education.netlify.app/static/bad5f02928a2842d0cf1f649d6f7d1da/edeef/logo-dark.webp'
                    alt="footer-logo"
                  />
                  :
                  <img style={{ filter: "grayscale(1)", opacity: 0.7, verticalAlign: "middle" }}
